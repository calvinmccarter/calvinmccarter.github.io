...
\hrulefill
 ...
 \textsc{Experience} 
     ...
     & Researched ways to accelerate deep learning inference on custom
       photonic hardware.
...
\fi
 ...
 \vspace{-15pt} \\{\color{green} ML} \\{\color{red}{CompArch}} \\ {\color{blue}{CompBio}} 
 ...
 \textsc{Preprints}
  ...
  & \\[0em]
 \textsc{Selected Refereed Publications}
  & \bul{C McCarter}, B Leibowitz, J Michuda, JS Bell, C Igartua, KP White.
    ``Transcriptome background tissue correction in metastatic cancers using a correlated composition admixture model'',
    \textit{Cancer Res. American Association for Cancer Research},
    vol: 80, 2020. \\[1.5em]
  & K Kandasamy, \gul{C McCarter}.
    ``Penalised Additive Least Squares Models for High Dimensional Nonparametric Regression and Function Selection'',
    \textit{Large-Scale Kernel Learning Workshop @ ICML}, 2015. \\[1.5em]
  & \\[0em]
 \textsc{Patents}
 ...
 \textsc{Languages}
  & Python (PyTorch, TensorFlow, pandas, NumPy, Numba), Matlab, C++, C, CUDA, Shell, \LaTeX\\[2.5em]
\iffalse
 \textsc{Presentations}
