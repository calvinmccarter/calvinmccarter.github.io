...
\usepackage{helvet}
%\usepackage{xcolor}
\usepackage[bmargin=0.85in,tmargin=0.85in,lmargin=0.9in,rmargin=0.9in]{geometry}
...
\hrulefill
 ...
 \textsc{About Me} 
     & AI researcher and engineer, with
       \hfill Boston, MA \\
 \textsc{ } 
     & $\triangleright$ first-author papers in NeurIPS, AISTATS, and TMLR,
 ...
 \textsc{ } 
     & $\triangleright$ extensive open-source software contributions, and
       \hfill (616) 272-0909 \\
     & $\triangleright$ experience training \& deploying neural networks at fast-paced teams. \\[1.5em]
 \textsc{Experience} 
     & \textbf{BigHat Biosciences}, Senior ML Scientist
       \hfill\textbf{March 2024 - Present}\\[0.25em]
     & Researching prior-data fitted networks (PFN) for pan-property few-shot learning. 
       Developing multi-objective guidance methods for sampling from protein language models, and deploying them to therapeutics programs.
       Designed protein language model fine-tuning methods for antibody property prediction.\\[1em]
     &\\[-0.5em]
     & \textbf{Amazon Alexa AI}, Applied Scientist
       \hfill\textbf{June 2022 - July 2023}\\[0.25em]
     & Researched and developed neural retrieval and ranking methods for entity resolution.
       Trained and deployed models to newly-onboarding Alexa use-cases, 
       designing and analyzing large-scale live traffic experiments to measure impact.\\[1em]
     &\\[-0.5em]
     ...
     & Researched ways to accelerate deep learning inference on photonic AI accelerator.
       ...
       and quantization.
       Helped invent next generation of hardware design to improve noise robustness.\\[3em]
     &\\[-0.5em]
     ...
     & Worked on server backend for Google Flight Search, developing functionality 
       for international results for live Flight Search queries.\\[2.4em]
\iffalse
...
\fi
 \textsc{Education} 
     ...
     & $\triangleright$ \ Selected Courses: 
       ...
       Foundations of Machine Learning Theory, Graduate Molecular Biology
     \\[2.0em]
     ...
     %  Numerical Methods, Linear Algebra, Theoretical Statistics
     \\[1.9em]
 \textsc{Languages}
  & Python (PyTorch, TensorFlow, pandas, NumPy, Numba), C, C++, CUDA, Matlab\\[1.0em]%, Shell, \LaTeX\\[2.5em]
 \textsc{Patents}
  & D Bunandar, \underline{C McCarter}, A Basumallik, ``Techniques of performing operations using a hybrid analog-digital processor.''
    US Patent App. 18/077,177 (2023).\\[0.5em] 
  & J Michuda, et int., \underline{C McCarter}, et al., ``Systems and methods for multilabel cancer classification.''
    US Patent App. 17/150,992 (2021).\\[2.0em]
 \textsc{Publications}
  & $\triangleright$ AN Amin, et int., \mlul{C McCarter}, et int., AG Wilson.
    ``Bayesian Optimization of Antibodies Informed by a Generative Model of Evolving Sequences.'',
    \href{https://arxiv.org/abs/2412.07763}{\textit{ICLR}}, 2025. \\[0.0em]
 \vspace{-10pt} \\{\color{YellowGreen}{CompArch}} \\ {\color{Dandelion}{CompBio}} \\{\color{RubineRed} ML} \vspace{-25pt}
  & $\triangleright$ \mlul{C McCarter}.
    ``Unmasking Trees for Tabular Data'',
    \href{https://openreview.net/pdf?id=0AxbTF3Ouq}{\textit{TMLR}}, 2025. \\[0.0em]
  & $\triangleright$ \mlul{C McCarter}.
    ``Towards Backwards-Compatible Data with Confounded Domain Adaptation'',
    \href{https://openreview.net/pdf?id=GSp2WC7q0r}{\textit{TMLR}}, 2024. \\[0.0em]
  & $\triangleright$ \mlul{C McCarter}.
    ``The Kernel Density Integral Transformation.''
    \href{https://openreview.net/pdf?id=6OEcDKZj5j}{\textit{TMLR}}, 2023. \\[0.0em]
  & $\triangleright$ J Michuda, et int., \cbul{C McCarter}, et int., T Taxter.
    ...
    \href{https://doi.org/10.1007/s40291-023-00650-5}{\textit{Mol Diagn Ther}}, 2023. \\[0.5em]
  & $\triangleright$ \mlul{C McCarter},
    ``Inverse distance weighting attention.''
    \href{https://arxiv.org/abs/2310.18805}{\textit{Associative Memory \& Hopfield Networks Workshop @ NeurIPS}}, 2023. \\[1.5em]
...
\fi
 ...
 \textsc{Activities}
  ...
  & Reviewer for \textit{NeurIPS} (Top Reviewer 2025), \textit{AISTATS}, and \textit{TMLR}.\\[0.5em]
