...
\hfill \url{http://www.cs.cmu.edu/~cmccarte/}
\vspace{-5pt}
...
\hrulefill
 ...
 \textsc{Research Experience} 
     & \textbf{Carnegie Mellon University}, Pittsburgh, PA \\[-0.95em]
     ...
     & Worked under the supervision of Valeria Bertacco 
       ...
       Designed and implemented parallel algorithm in CUDA. \\[0.5em]
 ...
 \textsc{Work Experience}
     & \textbf{Google}, Mountain View, CA
       \hfill\textbf{Summer 2012}\\[-0.95em]
 ...
 \textsc{Preprints}
  & \underline{C. McCarter}, J. Howrylak, S. Kim,
    ...
    \href{https://doi.org/10.1101/412817}{bioRxiv} doi:10.1101/412817, 2018. \\[1em]
 \textsc{Peer-Reviewed Publications}
  ...
  & D. Chatterjee, \underline{C. McCarter}, V. Bertacco, 
    ...
    2011 \\[1.5em]
 \textsc{Presentations}
  & \textit{An efficient algorithm for learning a gene network underlying clinical phenotypes under SNP perturbations.} (poster)\\
  & Genome Informatics meeting at Cold Spring Harbor Labs, November 2017.\\
  & \textit{Multi-modal structure learning in high dimensions for integrative genomics.} (talk)\\
 ...
 \textsc{Activities and Professional Service}
  ...
  & Reviewed publications for \textit{NIPS} and \textit{Statistics and Computing}.\\[0.5em]
  ...
  & \textit{Pennsylvania Junior Academy of Science}
    \hfill\textbf{February 2015}\\
  & Middle school science fair judge.\\[0.5em]
  & \textit{ML Department Masters Admissions Committee}
    \hfill\textbf{January 2015}\\
  & Reviewed application materials of prospective Masters students.\\[0.5em]
  & \textit{Machine Learning Department Student Research Symposium}
    \hfill\textbf{November 2014}\\
  & Member of organizing committee. Helped plan symposium and created website.\\[0.5em]
