...
\hrulefill
 ...
 \textsc{Experience} 
     ...
     & Researching ways to accelerate deep learning inference on custom
       photonic hardware, and to make model accuracy robust to noise and quantization.
       Helping guide development of next generation of hardware based
       on analysis of current results.\\[3em]
     &\\[-0.5em]
...
\fi
 ...
 \textsc{Papers}
  & A Basumallik, D Bunandar, N Dronen, L Levkova, \gul{C McCarter}, L Nair, D Walter, D Widemann,
    ``Adaptive Block Floating-Point for Analog Deep Learning Hardware.''
    \textit{Under review}, 2021. \\[1.5em]
 \vspace{-30pt} \\{\color{green} ML} \\{\color{red}{CompArch}} \\ {\color{blue}{CompBio}} 
  & R Hanson, D Martin, \bul{C McCarter}, J Paulson,
  ...
  & LE Fernandes, \dots, \bul{C McCarter}, et al., ``Real-world Evidence of Diagnostic Testing and Treatment Patterns
  ...
  & \bul{C McCarter}, J Howrylak, S Kim,
  ...
  & D Chatterjee, \rul{C McCarter}, V Bertacco, 
  ...
  & \\[0em]
 \textsc{Patents}
  & J Michuda, \dots, \bul{C McCarter}, et al., ``Systems and methods for multilabel cancer classification.''
    US Patent App. 17/150,992 (2021).\\[0.0em]
  & D Bunandar, \rul{C McCarter}, A Basumallik, ``Improving the accuracy of analog linear processor.''
