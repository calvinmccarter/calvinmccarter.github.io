...
\fi
 ...
 \textsc{Publications
 \vspace{5pt} \\ {\color{green} $^\S$ML}}
  & R Hanson, D Martin, \textbf{C McCarter}, J Paulson,
 ...
 \vspace{-15pt}
 \\{\color{red}{$^\dag$CompArch}} 
 \\ {\color{blue}{$^\natural$Bio}} 
  & LE Fernandes, \dots, \textbf{C McCarter}, et al., ``Real-world Evidence of Diagnostic Testing and Treatment Patterns
  ...
  & \textbf{C McCarter}, J Howrylak, S Kim,
  ...
  & \textbf{C McCarter} and S Kim, 
    ...
    \href{https://proceedings.neurips.cc/paper/2014/file/81c650caac28cdefce4de5ddc18befa0-Paper.pdf}{\textit{Advances in Neural Information Processing Systems (NeurIPS)}}, 
    2014. \\[1.5em]
  & S. Moon, \textbf{C McCarter}, YH Kuo,
    ``Active learning with partially featured data'',
    \textit{Proceedings of the 23rd International Conference on World Wide Web},
    2014. \\[1.5em]
  & \textbf{C McCarter}, D Kletter, H Tang, K Partyka, Y Ma, S Singh, 
  ...
  & D Chatterjee, \textbf{C McCarter}, V Bertacco, 
